    ...
    function() payable external
    {
        ...
        
        {
          ...
          if (msg.data.length == 20) {
            ...
            addressAdverstingProject.transfer(msg.value.mul(100-refer-sup-10).div(100));
               
            } else if (msg.data.length == 0) {
               
                addressAdverstingProject.transfer(msg.value.mul(100-sup-10).div(100));
            }
            
            addressSupportProject.transfer(msg.value.mul(sup).div(100));
